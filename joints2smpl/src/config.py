...
amass_idx =       range(24)
amass_smpl_idx =  range(24)


SMPL_MODEL_DIR = "/ailab/user/henantian/code/ConFiMo/data/"
GMM_MODEL_DIR = "/ailab/user/henantian/code/ConFiMo/joints2smpl/smpl_models"
SMPL_MEAN_FILE = "/ailab/user/henantian/code/ConFiMo/joints2smpl/smpl_models/neutral_smpl_mean_params.h5"
# for collsion 
Part_Seg_DIR = "/ailab/user/henantian/code/ConFiMo/joints2smpl/smpl_models/smplx_parts_segm.pkl"